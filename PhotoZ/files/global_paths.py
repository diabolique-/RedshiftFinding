...
images_directory = functions.check_for_slash(base_directory + "Astro/RS_finding/Data/Images/Gemini/Corrected/")

# SExtractor will run from here. This directory should hold the .sex and .param files that SExtractor uses
sextractor_params_directory = functions.check_for_slash(base_directory + "GoogleDrive/Research/SExtractor_files/")
...
catalogs_save_directory = functions.check_for_slash(base_directory + "GoogleDrive/Research/Data/Catalogs/Gemini/")
...
catalogs_look_directory = functions.check_for_slash(base_directory + "GoogleDrive/Research/Data/Catalogs/")

# Location for calibration catalogs to be saved to.
calibration_catalogs_directory = functions.check_for_slash(base_directory + "GoogleDrive/Research/Data/SDSS_catalogs")
